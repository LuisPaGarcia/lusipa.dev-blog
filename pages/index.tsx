      ...
      <Box sx={{ bg: 'white', color: 'black' }}>
        <Container mx={[4, 5, 6]} py={[4, 5]}>
          <Text as="h1" size={2} mb={[5, 6]} weight="medium" sx={{ textTransform: 'uppercase' }}>
            Luis<Text sx={{ color: 'gray' }}>Pa</Text>
          </Text>

          <Text as="p" size={5}>
            I'm a software gardener interested in design systems, jamstack, dev experience and engineering hacks.
          </Text>

          <Text as="p" size={5} mt={5}>
            Right now I'm working at{' '}
            <Link href="https://healthcare.com" target="_blank">
              Healthcare.com
            </Link>{' '}
            to help people to find the best health insurance.
          </Text>

          <Text as="p" size={5} mt={5}>
            Now living in Guatemala with my little family.
          </Text>

          <Text as="p" size={5} mt={5} mb={6}>
            You can find me on{' '}
            <Link href="https://twitter.com/diganluispa" target="_blank" variant="ghost">
              <TwitterIcon />
            </Link>{' '}
            or{' '}
            <Link href="https://github.com/luispagarcia" target="_blank" variant="ghost">
              <GithubIcon />
            </Link>
          </Text>
        </Container>
